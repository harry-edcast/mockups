...
if (!guideMe.baseUrl) {
	guideMe.baseUrl = "https://cdn.guideme.io/guideme-player/v3/";
}
...
function getScriptCB() {
	...
	function loadGuideMeClientFiles() {
		if (window.self === window.top) {
			a.src = GmCXt.conf.baseUrl + 'gm_client_1690013121851.js';
		} else {
			a.src = GmCXt.conf.baseUrl + 'gm_client_iframe_1690013121851.js';
		}
